                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        @foreach($alumnos as $alumno)
                            <tr>
                                ...
                                <td><img src="../../imagenes//tmp/phpqVBRib//tmp/phpqVBRib{{ $alumno->foto }}" class="img-raised rounded-circle" width="20px"/></td>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-12 offset-md-0">
                                @if (Auth::check())
                                  ...
                                  @else
                                    @if (Auth::user()->hasRole('student'))
                                      <a href="{{ route('alumnos/importacion') }}" class="btn btn-warning" disabled>Importar CSV</a>
                                    @else
                                      @if (Auth::user()->hasRole('teacher'))
                                        <a href="{{ route('alumnos/importacion') }}" class="btn btn-warning" disabled>Importar CSV</a>
                                      @else
