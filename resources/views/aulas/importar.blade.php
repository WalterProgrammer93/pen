...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header">Importar aulas</div>
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('aulas/importar') }}" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6 offset-md-4">
                              @if (Auth::check())
                                  @if (Auth::user()->hasRole('admin'))
                                    ...
                                    <a href="{{ route('aulas') }}" class="btn btn-primary">Cancelar</a>
                                  @else
