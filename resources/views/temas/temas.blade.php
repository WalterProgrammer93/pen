          ...
          <nav aria-label="breadcrumb">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('temas/buscar') }}" method="POST" role="form">
                        @csrf
                        <div class="col-md-20 justify-content-center m-3">
                            <div class="row justify-content-center m-3">
                                ...
                                <div class="col-md-4">
                                    <form action="{{ route('temas/filtro') }}" method="POST" role="form">
                    ...
                    <div class="row">
                        <div class="col-12 d-flex justify-content-center pt-2">
                            {{ $temas->appends(["temas" => $temas])->links() }}
                        </div>
                    </div>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-12 offset-md-0">
                                @if (Auth::check())
                                  ...
                                  <a href="{{ route('temas/exportar') }}" class="btn btn-danger">Exportar CSV</a>
                                  @if (Auth::user()->hasRole('admin'))
                                    <a href="{{ route('temas/importacion') }}" class="btn btn-warning">Importar CSV</a>
                                  @else
                                    @if (Auth::user()->hasRole('student'))
                                      <a href="{{ route('temas/importacion') }}" class="btn btn-warning" disables>Importar CSV</a>
                                    @else
                                      @if (Auth::user()->hasRole('teacher'))
                                        <a href="{{ route('temas/importacion') }}" class="btn btn-warning">Importar CSV</a>
                                      @else
                                        @if (Auth::user()->hasRole('user'))
                                          <a href="{{ route('temas/importacion') }}" class="btn btn-warning" disabled>Importar CSV</a>
                                        @endif
                                      @endif
                                    @endif
                                  @endif
